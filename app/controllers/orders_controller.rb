  ...
  def confirmation
    ...
    if request.patch?
      begin
        ...
        flash[:alert] = "
ما خیلی متاسف هستیم زمانیکه شما در حال بررسی سبد خرید خود بودید کالای انتخابی شما در انبار ما با کمبود مواجه شد، ما سبد خرید شما را با بیشترین تعداد ممکن به روز رسانی کردیم، اگر مایل به خرید هستید فقط کافیست از دکمه زیر استفاده کنید"
        redirect_to checkout_path
      end
    end
